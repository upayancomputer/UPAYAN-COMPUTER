...
export const Admission: React.FC<AdmissionProps> = ({ onBackToHome }) => {
  ...
  const generatePDF = () => {
    ...
    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(8.5);
    doc.text('Student Name (Bangla):', 15, 96);
    doc.setFont('Helvetica', 'bold');
    doc.text(nameBangla || 'N/A', 56, 96);

    doc.setFont('Helvetica', 'normal');
    doc.text('Student Name (English CAPITAL):', 15, 102);
    doc.setFont('Helvetica', 'bold');
    doc.text((nameEnglish || '').toUpperCase() || 'N/A', 56, 102);

    doc.setFont('Helvetica', 'normal');
    doc.text("Father's Name:", 15, 108);
    doc.text(fatherName || 'N/A', 56, 108);
    
    doc.text("Mother's Name:", 15, 114);
    doc.text(motherName || 'N/A', 56, 114);

    doc.text('Date of Birth:', 15, 120);
    doc.text(dob || 'N/A', 56, 120);
    doc.text('Gender:', 100, 120);
    doc.text(gender, 120, 120);

    doc.text('Nationality:', 15, 126);
    doc.text(nationality, 56, 126);
    doc.text('Religion:', 100, 126);
    doc.text(religion, 120, 126);

    doc.text('Blood Group:', 15, 132);
    doc.text(bloodGroup, 56, 132);
    doc.text('NID/Birth Reg No:', 100, 132);
    doc.text(nidBirth || 'N/A', 130, 132);

    doc.setFont('Helvetica', 'bold');
    doc.text('Student Mobile No:', 15, 138);
    doc.text(studentMobile || 'N/A', 56, 138);
    doc.setFont('Helvetica', 'normal');
    doc.text('Guardian Mobile No:', 100, 138);
    doc.text(guardianMobile || 'N/A', 130, 138);

    doc.text('Email Address:', 15, 144);
    doc.text(email || 'N/A', 56, 144);
    ...
    // Institutional Seals Block on Page 1 Bottom to balance page 1
    doc.setDrawColor(226, 232, 240);
    doc.line(12, 205, 198, 205);
    doc.setFont('Helvetica', 'italic');
    doc.setFontSize(8);
    doc.setTextColor(100, 116, 139);
    doc.text('Please flip block to Continuation Page (Page 2) for Educational Tables & Upload Verification Signatures.', 105, 212, { align: 'center' });

    // Seal box outlines on lower half
    doc.setDrawColor(203, 213, 225);
    doc.rect(15, 225, 45, 20);
    doc.rect(80, 225, 45, 20);
    doc.rect(145, 225, 45, 20);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(7.5);
    doc.text('VERIFICATION STAMP', 37.5, 236, { align: 'center' });
    doc.text('REGISTRABLE LEDGER', 102.5, 236, { align: 'center' });
    doc.text('DIRECTOR\'S SEAL', 167.5, 236, { align: 'center' });
    ...
    doc.setFontSize(9);
    doc.setTextColor(30, 41, 59);
    doc.text('SECTION 5 — EDUCATIONAL QUALIFICATIONS', 15, 34);

    // Educational Qualification Table
    // Row 1: Header
    doc.setFillColor(226, 232, 240);
    doc.rect(12, 40, 186, 8, 'F');
    doc.rect(12, 40, 186, 8);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(8);
    doc.setTextColor(15, 23, 42);
    // Columns: Exam (32), Board (32), Group (32), Year (30), Reg No (32), GPA (28)
    doc.text('Examination Name', 16, 45);
    doc.text('Board of Edu.', 48, 45);
    doc.text('Group / Subject', 80, 45);
    doc.text('Passing Year', 112, 45);
    doc.text('Registration No.', 144, 45);
    doc.text('GPA/Results', 176, 45);

    // SSC Row
    doc.rect(12, 48, 186, 8);
    doc.setFont('Helvetica', 'normal');
    doc.text('SSC or Equivalent', 16, 53);
    doc.text(sscBoard, 48, 53);
    doc.text(sscGroup, 80, 53);
    doc.text(sscYear || 'N/A', 112, 53);
    doc.text(sscRegNo || 'N/A', 144, 53);
    doc.setFont('Helvetica', 'bold');
    doc.text(sscGpa || 'N/A', 176, 53);

    // HSC Row
    doc.rect(12, 56, 186, 8);
    doc.setFont('Helvetica', 'normal');
    doc.text('HSC or Equivalent', 16, 61);
    doc.text(hscBoard, 48, 61);
    doc.text(hscGroup, 80, 61);
    doc.text(hscYear || 'N/A', 112, 61);
    doc.text(hscRegNo || 'N/A', 144, 61);
    doc.setFont('Helvetica', 'bold');
    doc.text(hscGpa || 'N/A', 176, 61);

    // Draw vertical column dividers for tables
    doc.line(44, 40, 44, 64);
    doc.line(76, 40, 76, 64);
    doc.line(108, 40, 108, 64);
    doc.line(140, 40, 140, 64);
    doc.line(172, 40, 172, 64);
    ...
    doc.setFontSize(9);
    doc.setTextColor(30, 41, 59);
    doc.text('SECTION 6 — ATTACHED DOCUMENTS CHECKLIST', 15, 74);
    ...
    // Row 1 (y = 82)
    drawPDFCheck('SSC Marksheet Copy', docs.sscMarksheet, 15, 82);
    drawPDFCheck('NID / Birth Certificate Copy', docs.nidBirth, 110, 82);

    // Row 2 (y = 88)
    drawPDFCheck('SSC Certificate Copy', docs.sscCertificate, 15, 88);
    drawPDFCheck('Passport Size Photo Attached', docs.photo, 110, 88);

    // Row 3 (y = 94)
    drawPDFCheck('HSC Marksheet Copy', docs.hscMarksheet, 15, 94);
    drawPDFCheck('Character Certificate Copy', docs.character, 110, 94);

    // Row 4 (y = 100)
    drawPDFCheck('HSC Certificate Copy', docs.hscCertificate, 15, 100);
    drawPDFCheck('Other Documents Attached', docs.other, 110, 100);

    // Section 7: Digital Upload Status Verification
    doc.setFillColor(241, 245, 249);
    doc.rect(12, 110, 186, 6, 'F');
    doc.setFont('Helvetica', 'bold');
    doc.text('SECTION 7 — DIGITAL PORTAL CLOUD UPLOAD STATUS', 15, 114);

    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(8);
    doc.text('The following digital file attachments were verified uploaded onto the local institution storage:', 15, 121);
    ...
    doc.setFont('Helvetica', 'bold');
    doc.text(`1. Student Passport Photo:`, 15, 127);
    ...
    doc.setFillColor(241, 245, 249);
    doc.rect(12, 144, 186, 6, 'F');
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(9);
    doc.text('SECTION 8 — APPLICANT INFORMATIONAL DECLARATION', 15, 148);
    ...
    doc.text(splitDeclText, 15, 155);

    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(8.5);
    doc.text('STUDENT DECLARATION AGREED STATUS: DIGITAL VERIFICATION SUCCESS', 15, 168);
    ...
    doc.line(20, 215, 75, 215);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(8.5);
    doc.text("Applicant's Signature", 47.5, 220, { align: 'center' });
    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(7.5);
    doc.text('Dated: ____/____/2026', 47.5, 224, { align: 'center' });

    // Director Signature line
    doc.line(135, 215, 190, 215);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(8.5);
    doc.text('Founder & Director Authorized', 162.5, 220, { align: 'center' });
    doc.text('UPAYAN Computer Training Center', 162.5, 224, { align: 'center' });
    doc.setFont('Helvetica', 'normal');
    doc.setFontSize(7.5);
    doc.text('Dated: ____/____/2026', 162.5, 228, { align: 'center' });

    // Official Stamp details inside a box
    doc.setDrawColor(203, 213, 225);
    doc.rect(15, 238, 180, 18);
    doc.setFont('Helvetica', 'bold');
    doc.setFontSize(7.5);
    doc.setTextColor(71, 85, 105);
    doc.text('OFFICIAL INSTITUTE ADMISSION VERIFICATION LEDGER STAMP BOX', 105, 243, { align: 'center' });
    doc.setFont('Helvetica', 'normal');
    doc.text('Admitted Date: _________________  |  Assigned Station: _________________  |  Authorized Operator: _________________', 105, 250, { align: 'center' });
        ...
        <div className="border-[3px] border-double border-slate-950 p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-start gap-4">
              <div className="flex-1 grid grid-cols-2 gap-x-4 gap-y-1.5 text-[10px]">
                <div className="col-span-2"><span className="font-semibold text-slate-600">Name (Bangla):</span> <strong>{nameBangla || 'N/A'}</strong></div>
                <div className="col-span-2"><span className="font-semibold text-slate-600">Name (English CAPITAL):</span> <strong className="uppercase">{nameEnglish || 'N/A'}</strong></div>
          ...
          <div className="space-y-2 pt-2">
            ...
            <table className="w-full border-collapse border border-slate-300 text-[9px] text-left">
              ...
              <tbody>
                <tr>
                  <td className="border border-slate-300 p-1 font-semibold">SSC Equivalent</td>
                ...
                <tr>
                  <td className="border border-slate-300 p-1 font-semibold">HSC Equivalent</td>
                  <td className="border border-slate-300 p-1">{hscBoard}</td>
                  <td className="border border-slate-300 p-1">{hscGroup}</td>
                  <td className="border border-slate-300 p-1">{hscYear || 'N/A'}</td>
                  <td className="border border-slate-300 p-1">{hscRegNo || 'N/A'}</td>
                  <td className="border border-slate-300 p-1 font-bold">{hscGpa || 'N/A'}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label className="text-xs font-bold font-mono text-slate-400 uppercase tracking-widest">Student Name (Bangla)</label>
                    <input
                      type="text"
                      value={nameBangla}
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold font-mono text-slate-400 uppercase tracking-widest">Student Name (English CAPITALLetters) *</label>
                    <input
                      type="text"
                      required
                      value={nameEnglish}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-8">
                  ...
                  {/* HSC Qualifications */}
                  <div className="border border-white/5 bg-white/[0.01] rounded-2xl p-5 space-y-4">
                    <h4 className="text-xs sm:text-sm font-bold font-display text-indigo-400 uppercase tracking-wider flex items-center gap-2">
                      <GraduationCap size={16} />
                      <span>HSC or Equivalent Record</span>
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-bold font-mono text-slate-400 uppercase tracking-wider">Board *</label>
                      ...
                      <div className="space-y-1.5">
                        ...
                        >
                          ...
                          <option value="Business Studies">Business Studies</option>
                          <option value="Humanities">Humanities</option>
                          <option value="Diploma / Eng">Diploma / Eng</option>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          placeholder="Registration number"
                          value={hscRegNo}
                          onChange={(e) => setHscRegNo(e.target.value)}
                          className="w-full h-10 px-3 rounded-xl bg-slate-900 border border-white/10 text-slate-100 text-xs focus:outline-none placeholder:text-slate-600"
                        />
                      </div>

                      <div className="space-y-1.5">
                        <label className="text-[10px] font-bold font-mono text-indigo-400 uppercase tracking-wider">GPA / Result *</label>
                        <input
                          type="text"
                          required
                          ...
                          className="w-full h-10 px-3 rounded-xl bg-slate-900 border border-indigo-500/20 text-slate-100 text-xs focus:outline-none placeholder:text-slate-600"
                        />
                      </div>
                    </div>
                  </div>
